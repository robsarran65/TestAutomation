...
def print_header(text):
    """Print a banner to visually separate demo phases in the console."""
    print(f"\n{'='*60}")
    print(f"  {text}")
    print(f"{'='*60}\n")
...
def main():
    """Run the six-phase demo end to end.

    Phase 3 drives a REAL Chrome browser against example.com, so it needs
    Chrome installed and network access. The other phases run offline.
    """
