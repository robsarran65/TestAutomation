"""
Streamlit UI (multi-agent mode) -- the primary entry point.

Same upload-and-run flow as app.py, but work is submitted to the Coordinator,
which routes it across the specialized agents (generation, execution,
validation, performance, reporting) and shows their live status in the UI.

Run with:  streamlit run src/ai_test_engine/app_multiagent.py
      or:  ai-test-engine        (installed console script)
"""
...
from ai_test_engine.agents.agent_base import TaskMessage, AgentType, TaskStatus
